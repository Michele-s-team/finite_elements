...
fieldnames_bcs = [ \
    ...
    '<<|u_n_12 - u_n_12_r|^2>>_{partial Omega r}' \
    ]
...
def print_bcs(psi):
    ...
    writer_bcs.writerows( [{ \
        ...
        fieldnames_bcs[6]: \
            f"{msh.abs_wrt_measure(sqrt((u_n_12_dummy[0] - rpam.parameters['u_n_12_r'][0])**2 + (u_n_12_dummy[1] - rpam.parameters['u_n_12_r'][1])**2), rmsh.ds_r):.{io.number_of_decimals}e}",\
        }] )
    csvfile_bcs.flush()
