...
P_X_n_12 = VectorElement('P', interval, rpam.parameters['function_space_degree'], dim=2)
...
element = MixedElement( [P_v_bar, P_w_bar, P_phi, P_v_n, P_w_n, P_X_n_12, P_nu_n_12, P_psi_n_12, P_mu_n_12] )
...
psi = Function(Q)
nu_v_bar, nu_w_bar, nu_phi, nu_v_n, nu_w_n, nu_X_n_12, nu_nu_n_12, nu_psi_n_12,  nu_mu_n_12 = TestFunctions( Q )
...
X_n_12_output = Function(Q_X_n_12)
...
X_n_12_0 = Function( Q_X_n_12)
nu_n_12_0 = Function( Q_nu_n_12 )
psi_n_12_0 = Function( Q_psi_n_12 )
mu_n_12_0 = Function( Q_mu_n_12 )


v_bar, w_bar, phi, v_n, w_n, X_n_12, nu_n_12, psi_n_12, mu_n_12 = split( psi )
V = (v_bar + v_n_1) / 2.0
W = (w_bar + w_n_1) / 2.0

assigner = FunctionAssigner(Q, [Q_v_bar, Q_w_bar, Q_phi, Q_v_n, Q_w_n, Q_X_n_12, Q_nu_n_12, Q_psi_n_12, Q_mu_n_12])
