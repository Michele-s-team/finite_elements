...
def print_solution(psi, step, t):
    ...
    files.xdmffile_v.write( v_n_dummy, t )
    files.xdmffile_w.write( w_n_dummy, t )
    files.xdmffile_sigma.write( fsp.sigma_n_12, t - vp.dt / 2.0 )
    files.xdmffile_phi.write( phi_dummy, t )
    files.xdmffile_X_n_12.write( X_n_12_dummy, t - vp.dt / 2.0 )
