...
boundary_square = 'on_boundary && sqrt(pow(x[0] - 0.2, 2) + pow(x[1] - 0.5/2.0, 2)) > (0.05 + 0.2)/2.0'
boundary_circle = 'on_boundary && sqrt(pow(x[0] - 0.2, 2) + pow(x[1] - 0.5/2.0, 2)) < (0.05 + 0.2)/2.0'
# CHANGE PARAMETERS HERE
