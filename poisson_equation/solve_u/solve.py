...
Examples:
    ...
    MESH_PATH="/home/fenics/shared/generate_mesh/3d/box_minus_ball/solution"; SOLUTION_PATH="/home/fenics/shared/poisson_equation/solve_u/solution"; rm -rf $SOLUTION_PATH; python3 solve.py box_ball $MESH_PATH $SOLUTION_PATH
