...
Examples:
    ...
    MESH_PATH="/home/fenics/shared/generate_mesh/2d/disk_vertices/solution"; SOLUTION_PATH="/home/fenics/shared/poisson_equation/solve_u/solution"; rm -rf $SOLUTION_PATH; python3 solve.py disk_vertices $MESH_PATH $SOLUTION_PATH
