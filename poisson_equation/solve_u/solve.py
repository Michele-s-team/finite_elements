...
clear; clear; SOLUTION_PATH="solution"; rm -rf $SOLUTION_PATH; mkdir -p $SOLUTION_PATH/nodal_values; python3 solve.py /home/fenics/shared/generate_mesh/2d/symmetric_square_circle/mirror_points/solution /home/fenics/shared/poisson_equation/solve_u/$SOLUTION_PATH
