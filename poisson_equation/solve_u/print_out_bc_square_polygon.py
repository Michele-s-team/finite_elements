...
print("Check of BCs:")
print(f"\t\t<<(u - phi)^2>>_[partial Omega tb + polygon] = {col.Fore.RED}{msh.difference_wrt_measure(fsp.u, fsp.u_exact, rmsh.ds_tb + rmsh.ds_polygon):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
print(
