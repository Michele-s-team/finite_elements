...
print(f"\t\t\t<<(u - phi)^2>>_[partial Omega {0}_{1}] = {col.Fore.RED}{msh.difference_wrt_measure(fsp.u[0][0], fsp.u_0_1_on_0_0, rmsh.ds_sub_mesh[0][0]['ds']):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
