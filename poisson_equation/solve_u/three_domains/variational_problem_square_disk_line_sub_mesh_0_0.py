...
class u_exact_sub_mesh_0_0_expression(UserExpression):
    def eval(self, values, x):
        ...
        # test case 2
        values[0] =  (9.0 * rmsh.lmsh.parameters['r']**2 * (rmsh.lmsh.parameters['c_r'][0] - x[0]) + (-rmsh.lmsh.parameters['c_r'][0] + x[0])**3 + 3.0 * (rmsh.lmsh.parameters['c_r'][0] - x[0]) * (rmsh.lmsh.parameters['c_r'][1] - x[1])**2 + 2.0 * (rmsh.lmsh.parameters['c_r'][1] - x[1])**3 + 18.0 * rmsh.lmsh.parameters['r']**2 * (-rmsh.lmsh.parameters['c_r'][1] + x[1]) + 6.0 * (rmsh.lmsh.parameters['c_r'][0] - x[0])**2 * (-rmsh.lmsh.parameters['c_r'][1] + x[1])) / (12.0 * rmsh.lmsh.parameters['r'])
...
class grad_u_exact_sub_mesh_0_0_expression(UserExpression):
    def eval(self, values, x):
        ...
        # test case 2
        values[0] = (-3.0 * rmsh.lmsh.parameters['r']**2 + (rmsh.lmsh.parameters['c_r'][0] - x[0])**2 + 4.0 * (rmsh.lmsh.parameters['c_r'][0] - x[0]) * (rmsh.lmsh.parameters['c_r'][1] - x[1]) - (rmsh.lmsh.parameters['c_r'][1] - x[1])**2) / (4.0 * rmsh.lmsh.parameters['r'])
        values[1] = (3.0 * rmsh.lmsh.parameters['r']**2 + (rmsh.lmsh.parameters['c_r'][0] - x[0])**2 - (rmsh.lmsh.parameters['c_r'][0] - x[0]) * (rmsh.lmsh.parameters['c_r'][1] - x[1]) - (rmsh.lmsh.parameters['c_r'][1] - x[1])**2) / (2.0 * rmsh.lmsh.parameters['r'])
