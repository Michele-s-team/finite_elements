...
print(f"\t\t\t<<(u - u_exact)^2>>_[partial Omega {0} lr] = {col.Fore.RED}{msh.difference_wrt_measure(fsp.u[0], fsp.u_exact[0], rmsh.ds_mesh[0]['ds_lr']):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
print(f"\t\t\t<<(u - u_exact)^2>>_[partial Omega {0} t] = {col.Fore.RED}{msh.difference_wrt_measure(fsp.u[0], fsp.u_1_on_0, rmsh.ds_mesh[0]['ds_t']):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
print(f"\t\t\t<<(u - u_exact)^2>>_[partial Omega {0} b] = {col.Fore.RED}{msh.difference_wrt_measure(fsp.u[0], fsp.u_exact[0], rmsh.ds_mesh[0]['ds_b']):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
