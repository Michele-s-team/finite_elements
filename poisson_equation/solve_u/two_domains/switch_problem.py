...
if rarg.args.problem == 'square_square':
    fsp = 'function_spaces_square_square'
    ...
    fsp = 'function_spaces_square_ellipse_circle'
...
elif rarg.args.problem == 'square_no_circle_line_a':
    fsp = 'function_spaces_square_no_circle_line'
    rmsh = 'mesh.read.square_no_circle_line'
    vp_sub_mesh_0 = 'variational_problem_square_no_circle_line_a_sub_mesh_0'
