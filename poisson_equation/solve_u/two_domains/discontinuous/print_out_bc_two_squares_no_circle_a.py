...
print(f"\t\t<<(u - phi)^2>>_[partial Omega square l] = {col.Fore.RED}{msh.difference_wrt_measure(fsp.u, fsp.u_exact_l, rmsh.ds_l + rmsh.ds_lt + rmsh.ds_lb):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
print(f"\t\t<<(u - phi)^2>>_[partial Omega square r] = {col.Fore.RED}{msh.difference_wrt_measure(fsp.u, fsp.u_exact_r, rmsh.ds_r + rmsh.ds_rt + rmsh.ds_rb):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
