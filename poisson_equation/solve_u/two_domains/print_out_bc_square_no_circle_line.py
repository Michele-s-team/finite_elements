...
print(f"\t\t\t<<(u - u_exact)^2>>_[partial Omega{1} lr] = {col.Fore.RED}{msh.difference_wrt_measure(fsp.u[1], fsp.u_exact[1], rmsh.ds_sub_mesh[1]['ds']):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
...
print(f'Sub_mesh {1}')
print(f"\t\t<<(u - u_exact)^2>>_Omega = {col.Fore.RED}{msh.difference_wrt_measure(fsp.u[1], fsp.u_exact[1], rmsh.dx_sub_mesh[1]):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
