...
print(f"\t\t\t<<|n^i partial_i u  - n^i grad_u_i|^2>>_[partial Omega {0} circle] = {col.Fore.RED}{msh.difference_wrt_measure(vp.sub_mesh_facet_normal[0][i] * (fsp.u[0].dx(i)), vp.sub_mesh_facet_normal[0][i] * fsp.grad_u[0][i], rmsh.ds_sub_mesh[0]['ds_circle']):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
...
print(f"\t\t\t<<|n^i partial_i u  - n^i grad_u_i|^2>>_[partial Omega {1} ellipse] = {col.Fore.RED}{msh.difference_wrt_measure(vp.sub_mesh_facet_normal[1][i] * (fsp.u[1].dx(i)), vp.sub_mesh_facet_normal[1][i] * fsp.grad_u[1][i], rmsh.ds_sub_mesh[1]['ds_ellipse']):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
