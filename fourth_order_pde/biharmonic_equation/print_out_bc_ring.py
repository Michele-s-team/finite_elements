...
print(f"\t<<(w - w_exact)^2>>_partial Omega = {col.Fore.RED}{msh.difference_on_boundary(w_output, fsp.w_exact):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
...
print(f"\t<<(w - w_exact)^2>>_Omega = {col.Fore.RED}{msh.difference_in_bulk(w_output, fsp.w_exact):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
