...
print(f"\t<<|omega - omega_exact|^2>>_Omega = {col.Fore.RED}{msh.abs_wrt_measure(geo.ufl_norm(omega_output - fsp.omega_exact), rmsh.dx):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
