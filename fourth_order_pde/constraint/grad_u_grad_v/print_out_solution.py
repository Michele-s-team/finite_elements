...
fsp.z_output, fsp.u_output, fsp.omega_z_output,  fsp.omega_u_output, fsp.mu_output = fsp.psi.split(deepcopy=True)
...
io.full_print(fsp.u_output, 'u', solpath.xdmf_file_path, solpath.h5_file_path, solpath.csv_files_path,
              solpath.nodal_values_path,
              'scalar')
io.full_print(fsp.omega_z_output, 'omega', solpath.xdmf_file_path, solpath.h5_file_path, solpath.csv_files_path,
              solpath.nodal_values_path,
              'vector')
