...
This file needs the mesh files, which can be generated by `finite_elements/mesh/membrane_mesh/generate_square_mesh.py` or ``finite_elements/mesh/membrane_mesh/generate_ring_mesh.py`` with
