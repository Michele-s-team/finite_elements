...
F_dot = ( \
                    (ela.F_dot(fsp.u_dot)[k, j] * ela.S(fsp.u, ela.K(fsp.u, vp.exponent), ela.mu(fsp.u, vp.exponent))[j, i] \
                     + ela.F(fsp.u)[k, j] * ela.S_dot(fsp.u, fsp.u_dot, ela.K(fsp.u, vp.exponent), ela.mu(fsp.u, vp.exponent))[j, i]) \
