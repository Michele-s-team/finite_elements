...
print("Check of BCs:")
print(f"\t\t<<(u_1 - phi_1)^2>>_[partial Omega ] = {col.Fore.RED}{msh.difference_wrt_measure(fsp.u[0], fsp.u_in[0], rmsh.ds):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
print(f"\t\t<<(u_2 - phi_2)^2>>_[partial Omega ] = {col.Fore.RED}{msh.difference_wrt_measure(fsp.u[1], fsp.u_in[1], rmsh.ds):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
