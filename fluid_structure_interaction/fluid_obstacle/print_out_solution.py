...
def print_solution_di_fluid(t, step):
    ...
    io.full_print_deformed(phi_disk_output, fsp.u_n_di, 'phi_disk_' + str(step), \
                  solpath.snapshots_path, solpath.snapshots_h5_path, solpath.snapshots_csv_path, solpath.snapshots_csv_nodal_values_path, lmsh.sub_meshes[0][0])
...
def print_solution_sq_fluid(t, step):
    ...
    io.full_print_deformed(fsp.v_square__, fsp.u_n_sq, 'v_square__' + str(step), \
                  solpath.snapshots_path, solpath.snapshots_h5_path, solpath.snapshots_csv_path, solpath.snapshots_csv_nodal_values_path, lmsh.sub_meshes[0][1])
