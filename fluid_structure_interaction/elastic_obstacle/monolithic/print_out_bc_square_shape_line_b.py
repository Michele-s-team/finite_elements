...
def print_bcs(step):
            ...
            f"{msh.abs_wrt_measure(geo.ufl_norm(fsp.v_n - fsp.v_lrtb), rmsh.ds_mesh[0]['ds']):.{rpam.parameters['print_out_digits']}e}",\
        fi.fieldnames_bcs[2]: \
            ...
            f"{msh.abs_wrt_measure(sqrt(fsp.sigma_n**2), rmsh.ds_mesh[0]['ds_t']):.{rpam.parameters['print_out_digits']}e}",\
        fi.fieldnames_bcs[4]: \
