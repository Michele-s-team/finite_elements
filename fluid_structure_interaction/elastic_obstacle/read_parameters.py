...
rho_elastic = io.read_parameter_from_csv_file("parameters.csv", "rho_elastic", float)
...
print(f'rho_fluid = {rho_fluid}, mu_fluid = {mu_fluid}, v_l = {v_l}, T = {T},  num_steps = {num_steps}, exponent = {exponent}, rho_elastic = {rho_elastic}, K_elastic = {K_elastic}, mu_elastic = {mu_elastic}')