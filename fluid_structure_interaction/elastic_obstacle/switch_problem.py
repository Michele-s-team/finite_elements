...
if rarg.args.problem == 'square_ellipse_circle':
    ...
    vp_elastic = 'variational_problem_elastic_bc_square_ellipse_circle'
    vp_fluid = 'variational_problem_fluid_bc_square_ellipse_circle'
    vp_mesh = 'variational_problem_mesh_bc_square_ellipse_circle'
