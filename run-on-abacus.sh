...
# run with ./run-on-abacus.sh fluid_structure_interaction fluid_structure_interaction_3 ~/Documents/finite_elements/generate_mesh/2d/square/ellipse/solution
