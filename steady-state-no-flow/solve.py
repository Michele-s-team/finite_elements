...
Examples:
    ...
    - to read the mesh from generate_mesh/2d/square/symmetric_top_bottom:
        clear; clear; SOLUTION_PATH="solution"; rm -rf $SOLUTION_PATH; mkdir -p $SOLUTION_PATH/nodal_values; python3 solve.py /home/fenics/shared/generate_mesh/2d/square/symmetric_top_bottom/solution/ /home/fenics/shared/steady-state-no-flow/$SOLUTION_PATH
