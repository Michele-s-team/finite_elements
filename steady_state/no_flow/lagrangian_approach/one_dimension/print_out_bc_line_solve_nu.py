...
print(
    f"\t\t<<(nu - nu_l)^2>>_[partial Omega l] = {col.Fore.RED}{msh.difference_wrt_measure(prout_sol.nu_output, rpam.parameters['nu_l'], rmsh.ds_l):.{io.number_of_decimals}e}{col.Style.RESET_ALL}")
