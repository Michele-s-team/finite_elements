...
This file needs the mesh files, which can be generated by `/home/fenics/shared/steady_state/flow/mesh/generate_square_mesh.py` or `/home/fenics/shared/steady_state/flow/mesh/generate_ring_mesh.py`` with
python3 generate_square_mesh.py 0.1
python3 generate_ring_mesh.py 0.1
and which are stored into /home/fenics/shared/steady_state/flow/mesh
