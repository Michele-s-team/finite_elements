...
print("F_circle = ",\
      [assemble(dFdl * bgeo.sqrt_deth_circle(prout.omega_output, prout.rmsh.parameters["c_r"]) * (1.0 / prout.rmsh.parameters["r"]) * prout.rmsh.ds_circle) for dFdl in dFdl_tot_3d_to_assemble])
