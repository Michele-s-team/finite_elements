...
msh.test_mesh_integral(integral_exact_dx_l, function_test_integrals_fenics, rmsh.dx_l, '\int f dx_l')
msh.test_mesh_integral(integral_exact_dx_r, function_test_integrals_fenics, rmsh.dx_r, '\int f dx_r')
...
msh.test_mesh_integral(integral_exact_ds_lb, function_test_integrals_fenics, rmsh.ds_lb, '\int f ds_lb')
msh.test_mesh_integral(integral_exact_ds_rb, function_test_integrals_fenics, rmsh.ds_rb, '\int f ds_rb')
msh.test_mesh_integral(integral_exact_ds_mid, function_test_integrals_fenics, rmsh.ds_m, '\int f ds_mid')
msh.test_mesh_integral(integral_exact_ds_lt, function_test_integrals_fenics, rmsh.ds_lt, '\int f ds_lt')
msh.test_mesh_integral(integral_exact_ds_rt, function_test_integrals_fenics, rmsh.ds_rt, '\int f ds_rt')
