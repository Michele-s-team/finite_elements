...
integral_exact_dx_r_rho = cal.surface_integral_ring(function_test_integrals, rmsh.parameters["r"], rmsh.parameters["rho"], rmsh.parameters["c_r"])
integral_exact_dx_rho_R = cal.surface_integral_ring(function_test_integrals, rmsh.parameters["rho"], rmsh.parameters["R"], rmsh.parameters["c_r"])

integral_exact_dx = integral_exact_dx_r_rho +  integral_exact_dx_rho_R

integral_exact_ds_r = cal.curve_integral_circle(function_test_integrals, rmsh.parameters["r"], rmsh.parameters["c_r"])
integral_exact_ds_rho = cal.curve_integral_circle(function_test_integrals, rmsh.parameters["rho"], rmsh.parameters["c_rho"])
integral_exact_ds_R = cal.curve_integral_circle(function_test_integrals, rmsh.parameters["R"], rmsh.parameters["c_R"])
