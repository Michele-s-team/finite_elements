...
integral_exact_dx = cal.surface_integral_rectangle(tf.function_test_integrals, [0, 0], [rmsh.parameters["L"], rmsh.parameters["h"]]) - \
                    cal.surface_integral_ellipse(tf.function_test_integrals,
...
test_mesh_integral_errors['\int f ds_ellipse'] = msh.test_mesh_integral(integral_exact_ds_ellipse, tf.function_test_integrals_fenics, rmsh.ds_ellipse, '\int f ds_ellipse')

test_mesh_integral_errors['\int f ds_{l + tb + ellipse}'] = msh.test_mesh_integral(integral_exact_ds_l + integral_exact_ds_tb + integral_exact_ds_ellipse, tf.function_test_integrals_fenics, rmsh.ds_l_tb_ellipse, '\int f ds_{l + tb + ellipse}')
