...
integral_exact_dx = cal.surface_integral_rectangle(tf.function_test_integrals, [0, 0], [rmsh.parameters["L"], rmsh.parameters["h"]])  - cal.surface_integral_polygon(tf.function_test_integrals, rmsh.polygon_coordinates)
...
integral_exact_ds_poly = cal.curve_integral_polygon(tf.function_test_integrals, rmsh.polygon_coordinates)
