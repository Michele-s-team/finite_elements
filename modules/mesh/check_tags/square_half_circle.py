...
integral_exact_ds_t = cal.curve_integral_line(tf.function_test_integrals, [0, rmsh.parameters['h']], [rmsh.parameters['c_r_x'] - rmsh.parameters['r'], rmsh.parameters['h']]) \
                        + cal.curve_integral_circle_arc(tf.function_test_integrals, rmsh.parameters['r'], np.pi, 2*np.pi, [rmsh.parameters['c_r_x'], rmsh.parameters['h']]) \
                        + cal.curve_integral_line(tf.function_test_integrals,  [rmsh.parameters['c_r_x'] + rmsh.parameters['r'], rmsh.parameters['h']], [rmsh.parameters['L'], rmsh.parameters['h']]) 
