...
integral_exact_dx = cal.surface_integral_rectangle(tf.function_test_integrals, [0, 0], [rmsh.parameters["L"], rmsh.parameters["h"]]) - \
                    cal.surface_integral_disk(tf.function_test_integrals, rmsh.parameters["r"], rmsh.parameters["c_r"][:2])
...
integral_exact_ds_circle = cal.curve_integral_circle(tf.function_test_integrals, rmsh.parameters["r"], rmsh.parameters["c_r"][:2])
...
test_mesh_integral_errors['\int f ds_circle'] = msh.test_mesh_integral(integral_exact_ds_circle, tf.function_test_integrals_fenics, rmsh.ds_circle, '\int f ds_circle')
