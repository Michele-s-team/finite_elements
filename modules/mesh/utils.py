...
Return values:
    ...
    - 'sf_sub_meshes':  a list containing a function to tag the sub_mesh cells. cf_sub_meshes[i] contains a function to tag cells of the i-th sub_mesh if sub_mesh[i] is one-dimensional, and it is None otherwise
