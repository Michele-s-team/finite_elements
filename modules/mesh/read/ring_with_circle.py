...
dx_rho_R = Measure("dx", domain=lmsh.mesh, subdomain_data=sf, subdomain_id=2)
ds_r = Measure("ds", domain=lmsh.mesh, subdomain_data=mf, subdomain_id=3)
ds_rho = Measure("dS", domain=lmsh.mesh, subdomain_data=mf, subdomain_id=4)
ds_R = Measure("ds", domain=lmsh.mesh, subdomain_data=mf, subdomain_id=5)
