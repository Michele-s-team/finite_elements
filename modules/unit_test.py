...
- 'success': A list with only one boolean enty, which will be set to True(False) if all commands in the method call have run successfully or not, respectively
Output values: 
