...
to make figure-4: 
- select bc_square_a
- set in /home/fenics/shared/generate_mesh/2d/symmetric_square_circle/mirror_point/generate_mesh_square.py
    * the parameters
        r = 0.01
        L = 1
        h = 1
...
- generate the mesh with 
    ~/shared/generate_mesh/2d/symmetric_square_circle/mirror_points$ clear; clear; SOLUTION_PATH="solution"; rm -rf $SOLUTION_PATH; mkdir $SOLUTION_PATH; python3 generate_mesh_square.py 0.01 $SOLUTION_PATH
- run with 
    clear; clear; SOLUTION_PATH="solution"; rm -rf $SOLUTION_PATH; mkdir -p $SOLUTION_PATH/nodal_values; python3 solve.py /home/fenics/shared/generate_mesh/2d/symmetric_square_circle/mirror_points/solution /home/fenics/shared/steady-state-flow/$SOLUTION_PATH    
'''
