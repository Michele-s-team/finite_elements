...
Run with
    clear; clear; python3 generate_submesh_box.py [path where to find the mesh]
Example:
    clear; clear; python3 generate_submesh_box.py /home/fenics/shared/generate_mesh/3d/box/solution
'''
