<<<<<<< HEAD:generate-mesh/2d/symmetric-square-circle/mirror_points/read_mesh_square.py
'''
...
import check_mesh_tags_square
>>>>>>> origin/master:generate_mesh/2d/square/symmetric_top_bottom/mirror_points/read_mesh_square.py
