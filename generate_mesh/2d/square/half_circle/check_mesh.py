...
Example:
    clear; clear; MESH_PATH="/home/fenics/shared/generate_mesh/2d/square/half_circle/solution"; CHECK_PATH="/home/fenics/shared/generate_mesh/2d/square_circle/check"; rm -rf $CHECK_PATH; mkdir $CHECK_PATH; python3 check_mesh.py $MESH_PATH $CHECK_PATH
 '''
