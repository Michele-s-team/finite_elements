...
Example:
    clear; clear; PARAMETERS_PATH="/home/fenics/shared/generate_mesh/2d/square/circles/"; SOLUTION_PATH="/home/fenics/shared/generate_mesh/2d/square/circles/solution"; rm -rf $SOLUTION_PATH; mkdir $SOLUTION_PATH; python3 generate_mesh.py $PARAMETERS_PATH $SOLUTION_PATH
'''
...
for j in range(rpam.parameters["n_aux_circles"]):
    aux_r = rpam.parameters["r_min"] + (rpam.parameters["r_max"] - rpam.parameters["r_min"]) * j / (rpam.parameters["n_aux_circles"] - 1)
