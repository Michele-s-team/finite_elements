...
Run with
    clear; clear; python3 generate_ing_with_circle_mesh.py [path where to read the parameter file] [path where to store the solution]
Example:
    clear; clear; PARAMETERS_PATH="/home/fenics/shared/generate_mesh/2d/ring/ring_with_circle"; SOLUTION_PATH="/home/fenics/shared/generate_mesh/2d/ring/ring_with_circle/solution"; rm -rf $SOLUTION_PATH; mkdir $SOLUTION_PATH; python3 generate_ring_with_circle_mesh.py $PARAMETERS_PATH $SOLUTION_PATH
'''
