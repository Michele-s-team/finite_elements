...
gmsh.model.addPhysicalGroup(lines[0][0],[lines[0][1]],rpam.parameters["sub_mesh_2_id"])
gmsh.model.setPhysicalName(lines[0][0],rpam.parameters["sub_mesh_2_id"],"sub_mesh_2")
