...
Run with
    clear; clear; python3 generate_mesh_line.py [path where to read the parameter file] [path where to store the solution]
Example:
    clear; clear; PARAMETERS_PATH="/home/fenics/shared/generate_mesh/1d/line_vertex"; SOLUTION_PATH="/home/fenics/shared/generate_mesh/1d/line_vertex/solution"; rm -rf $SOLUTION_PATH; mkdir $SOLUTION_PATH; python3 generate_mesh_line.py $PARAMETERS_PATH $SOLUTION_PATH
'''
