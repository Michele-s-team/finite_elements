...
boundary_tb  = 'near(x[1], 0) || near(x[1], 2.2)'
boundary_square = 'on_boundary && sqrt(pow(x[0] - 2.2/2.0, 2) + pow(x[1] - 2.2/2.0, 2)) > 0.1'
boundary_circle = 'on_boundary && sqrt(pow(x[0] - 2.2/2.0, 2) + pow(x[1] - 2.2/2.0, 2)) < 0.1'
#CHANGE PARAMETERS HERE
