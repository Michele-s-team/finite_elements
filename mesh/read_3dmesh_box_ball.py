...
example:
clear; clear; python3 read_3dmesh_box_ball.py /home/fenics/shared/mesh/solution
'''
...
ds_ri = Measure( "ds", domain=mesh, subdomain_data=sf, subdomain_id=6 )
ds_fr = Measure( "ds", domain=mesh, subdomain_data=sf, subdomain_id=2 )
ds_ba = Measure( "ds", domain=mesh, subdomain_data=sf, subdomain_id=4 )
ds_bo = Measure( "ds", domain=mesh, subdomain_data=sf, subdomain_id=5 )
ds_to = Measure( "ds", domain=mesh, subdomain_data=sf, subdomain_id=3 )
...
exact_value_int_ds_to = 0.489414
...
exact_value_int_ds_bo = 0.505778
