'''
This code reads the box generated by generate_3dmesh_box.py and creates a square, 2d mesh given by the xz side of the box
run with
clear; clear; python3 submesh_3dmesh_box.py [path where to find the mesh]
example:
clear; clear; python3 submesh_3dmesh_box.py /home/fenics/shared/generate-mesh/solution
'''
