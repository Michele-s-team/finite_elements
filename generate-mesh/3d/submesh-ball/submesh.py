'''
This code reads the ball generated by ~/shared/generate_mesh
/3d/ball/generate_mesh.py  and creates a sphere mesh given by the boundary of the ball

run with
clear; clear; python3 submesh.py [path where to find the mesh]
example:
clear; clear; python3 submesh.py /home/fenics/shared/generate_mesh
/3d/ball/solution
'''
