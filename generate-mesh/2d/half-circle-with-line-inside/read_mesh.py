...
msh.test_mesh_integral(cal.integral_curve(function_test_integral_expression, curve_line_12), f_test, dline_12, '\int dl f_{line_12}')
msh.test_mesh_integral(cal.integral_curve(function_test_integral_expression, curve_arc_21), f_test, darc_21, '\int dl f_{arc_21}')
