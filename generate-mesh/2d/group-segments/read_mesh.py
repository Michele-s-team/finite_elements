...
clear; clear; python3 read_mesh.py /home/fenics/shared/generate-mesh/2d/group-segments/solution
'''
import argparse
from dolfin import *
from fenics import *
...
ds_semicircle = Measure("ds", domain=mesh, subdomain_data=cf, subdomain_id=6)
...
msh.test_mesh_integral(2.393179742560636, f_test, ds_semicircle, '\int ds_semicircle f')
