...
Example:
    MESH_PATH="/home/fenics/shared/generate_mesh/2d/square/solution"; SOLUTION_IN_PATH="/home/fenics/shared/dynamics/channel_with_cylinder_curved_cn/solution/snapshots/h5"; SOLUTION_OUT_PATH="/home/fenics/shared/read_write/collate_snapshots/solution"; rm -rf $SOLUTION_OUT_PATH; python3 solve.py square $MESH_PATH $SOLUTION_IN_PATH $SOLUTION_OUT_PATH
    MESH_PATH="/home/fenics/shared/generate_mesh/3d/box_ball/solution"; SOLUTION_IN_PATH="/home/fenics/shared/dynamics/channel_with_cylinder_flat_icps/solution/snapshots/h5"; SOLUTION_OUT_PATH="/home/fenics/shared/read_write/collate_snapshots/solution"; rm -rf $SOLUTION_OUT_PATH; python3 solve.py box_ball $MESH_PATH $SOLUTION_IN_PATH $SOLUTION_OUT_PATH
'''
...
Q = FunctionSpace(lmsh.sub_meshes[1], element)
