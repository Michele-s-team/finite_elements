...
Example:
    MESH_PATH="/home/fenics/shared/generate_mesh/2d/square/solution"; INPUT_PATH="/home/fenics/shared/read_write/read_fields/input"; SOLUTION_PATH="/home/fenics/shared/read_write/read_fields/solution"; rm -rf $SOLUTION_PATH; python3 solve.py $MESH_PATH $INPUT_PATH $SOLUTION_PATH
'''
