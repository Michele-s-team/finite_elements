...
checks[case_name + '_' + problem_name] = utest.test_generate_mesh_and_solve(commit_a, commit_b,
                                                                     ...
                                                                     generate_mesh_path, root_path + case_name,
                                                                     mesh_solution_path_a, problem_solution_path_a, mesh_solution_path_b, problem_solution_path_b,
                                                                     'generate_two_squares_no_circle_mesh', generate_mesh_path, generate_mesh_path, problem_name, problem_name, success)
...
checks[case_name + '_' + problem_name] = utest.test_generate_mesh_and_solve(commit_a, commit_b,
                                                                     ...
                                                                     generate_mesh_path, root_path + case_name,
                                                                     mesh_solution_path_a, problem_solution_path_a, mesh_solution_path_b, problem_solution_path_b,
                                                                     'generate_ball_mesh', generate_mesh_path, generate_mesh_path, problem_name, problem_name, success)
...
checks[case_name + '_' + problem_name] = utest.test_generate_mesh_and_solve(commit_a, commit_b,
                                                                     ...
                                                                     generate_mesh_path, root_path + case_name,
                                                                     mesh_solution_path_a, problem_solution_path_a, mesh_solution_path_b, problem_solution_path_b,
                                                                     'generate_box_mesh', generate_mesh_path, generate_mesh_path, problem_name, problem_name, success)
...
checks[case_name + '_' + problem_name] = utest.test_generate_mesh_and_solve(commit_a, commit_b,
                                                                     ...
                                                                     generate_mesh_path, root_path + case_name,
                                                                     mesh_solution_path_a, problem_solution_path_a, mesh_solution_path_b, problem_solution_path_b,
                                                                     'generate_box_ball_mesh', generate_mesh_path, generate_mesh_path, problem_name, problem_name, success)
...
checks[case_name + '_' + problem_name] = utest.test_generate_mesh_and_solve(commit_a, commit_b,
                                                                     ...
                                                                     generate_mesh_path, root_path + case_name,
                                                                     mesh_solution_path_a, problem_solution_path_a, mesh_solution_path_b, problem_solution_path_b,
                                                                     'generate_square_mesh', generate_mesh_path + 'high_res_parameters/', generate_mesh_path + 'high_res_parameters/', problem_name, problem_name, success)
