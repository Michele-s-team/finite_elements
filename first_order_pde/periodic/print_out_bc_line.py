...
print(
    f"\t\t<<(grad_u - grad_u_exact)^2>>_Omega = {col.Fore.RED}{msh.abs_wrt_measure((fsp.grad_u[i] - fsp.grad_u_exact[i]) * (fsp.grad_u[i] - fsp.grad_u_exact[i]), rmsh.dx):.{sys_io.number_of_decimals}e}{col.Style.RESET_ALL}")
